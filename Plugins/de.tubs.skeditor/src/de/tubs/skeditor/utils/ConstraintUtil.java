...
public class ConstraintUtil {
	...
	private static Category[] mainParent = {Category.MAIN}, mainChild = { Category.OBSERVABLE_EXTERNAL_BEHAVIOR, Category.ACTION, Category.PLANNING , Category.PERCEPTION, Category.ACTUATOR ,Category.SENSOR };
	private static Category[] obsParent = { Category.MAIN , Category.OBSERVABLE_EXTERNAL_BEHAVIOR}, obsChild = { Category.OBSERVABLE_EXTERNAL_BEHAVIOR, Category.ACTION, Category.PLANNING , Category.PERCEPTION };
	...
	private static Category[] perceptionParent = { Category.MAIN, Category.OBSERVABLE_EXTERNAL_BEHAVIOR, Category.PLANNING, Category.ACTION, Category.PERCEPTION }, perceptionChild = { Category.SENSOR, Category.PERCEPTION };
